...
import sty from "./PlasmicThemeBtn.module.css"; // plasmic-import: OFOxy67RyMdT/css
import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: CWXe1ywOBmQJ/icon

createPlasmicElementProxy;

export const PlasmicThemeBtn__VariantProps = new Array(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export const PlasmicThemeBtn__ArgProps = new Array(
  "children",
  "startIcon",
  "endIcon",
  "link",
...
function PlasmicThemeBtn__RenderFunc(props) {
    ...
    <Stack__
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootcolor_themebtn]: hasVariant($state, "color", "themebtn"),
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg___8Shx)}
                role={"img"}
              />
            ),
      ...
      >
        {renderPlasmicSlot({
          ...
          className: classNames(sty.slotTargetChildren, {
            ...
            [sty.slotTargetChildrencolor_themebtn]: hasVariant(
              $state,
              "color",
              "themebtn"
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__e6Jka)}
                role={"img"}
              />
            ),
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicThemeBtn__ArgProps,
          internalVariantPropNames: PlasmicThemeBtn__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicThemeBtn__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicThemeBtn";
  } else {
    func.displayName = `PlasmicThemeBtn.${nodeName}`;
  }
  return func;
}

export const PlasmicThemeBtn = Object.assign(
  // Top-level PlasmicThemeBtn renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicThemeBtn
    internalVariantProps: PlasmicThemeBtn__VariantProps,
    internalArgProps: PlasmicThemeBtn__ArgProps,
    useBehavior
  }
);

export default PlasmicThemeBtn;
/* prettier-ignore-end */
