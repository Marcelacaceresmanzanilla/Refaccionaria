...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: q85bUZ7uEhyH/css
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: xz7rbfTa4-W4/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: o8451l6SF050/icon
...
function PlasmicPageLayout__RenderFunc(props) {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__x9N)}
          role={"img"}
        />
      }
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__xORjL)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__ndPsn)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__mWkz)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section___9S0RE)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
